...
/**
 * Aktion zum Hinzufügen eines neuen Bauelements zur Optischen Bank
 */
public class Aktion_BauelementHinzufuegen implements Aktion {
    ...
    //Bauelement, dass hinzugefügt werden soll.
    private Bauelement bauelement;

    /**
     * Initialisiert die Aktion BauelementHinzufuegen.
     *
     * @param optischeBank Optische Bank, zu der das Bauelement hinzugefügt werden soll.
     * @param bauelement   Bauelement, das hinzugefügt werden soll.
     */
    ...
    public void aktionDurchfuehren() {
        //Fügt das Bauelement der Optische Bank hinzu:
        optischeBank.bauelementHinzufuegen(bauelement);
    }

    @Override
    public void aktionRueckgaengig() {
        //Löscht das Bauelement wieder aus der Optischen Bank:
